...
Q_t(a) = \frac{\text{sum of rewards when a taken prior to t}}{\text{number of times a taken prior to t}} = \frac{\sum_{i=1}^{t-1}R_i \cdot \mathbbm{1}_{A_{i=a}}}{\sum_{i=1}^{t-1}\mathbbm{1}_{A_{i=a}} }
\end{equation}
